...
std::string get_serialized_game_board() {
	...
	do {
		...
		if (!is_valid_serialized_game_board(input) && input.compare(_exit) != 0 && input.compare(_restart) != 0) {
...
/* ========================================================================================================== */
bool is_valid_traversal_input(std::string &traversal_input) {
	return traversal_input.compare(_preorder) == 0 || traversal_input.compare(_postorder) == 0 ||
	       traversal_input.compare(_levelorder) == 0 || traversal_input.compare(_linked_pre_order) == 0 ||
	       traversal_input.compare(_linked_post_order) == 0 || traversal_input.compare(_random_branch) == 0;
}
